...
#define CONF_SPI_1_ENABLE 1
#endif

// Set module in SPI Master mode
#ifndef CONF_SPI_1_MODE
#define CONF_SPI_1_MODE 0x01
#endif

// Set FIFO disable
#ifndef CONF_SPI_1_FIFO_DISABLE
#define CONF_SPI_1_FIFO_DISABLE 0x01
#endif

// Set peripheral select as fixed
#ifndef CONF_SPI_1_PS
#define CONF_SPI_1_PS 0x0
#endif

// Set chip select decode as directly
#ifndef CONF_SPI_1_PCSDEC
...
// <i> The SPI data transfer rate. Note: (fspi_clock / baudrate) < 255
// <id> spi_master_baud_rate
#ifndef CONF_SPI_1_BAUD
#define CONF_SPI_1_BAUD 100000
#endif
...
// <e> Advanced Configuration
// <id> spi_master_advanced
#ifndef CONF_SPI_1_ADVANCED
#define CONF_SPI_1_ADVANCED 0
#endif

// <o> Dummy byte <0x00-0xFFFF>
// <id> spi_master_dummybyte
// <i> Dummy byte used when reading data from the slave without sending any data
#ifndef CONF_SPI_1_DUMMYBYTE
#define CONF_SPI_1_DUMMYBYTE 0xffff
#endif
...
// <i> Determines the inactive state value of the serial clock (SPCK).
// <id> spi_master_arch_cpol
#ifndef CONF_SPI_1_CPOL
#define CONF_SPI_1_CPOL 0x0
#endif
...
// <i> Determines which edge of SPCK causes data to change and which edge causes data to be captured.
// <id> spi_master_arch_cpha
#ifndef CONF_SPI_1_NCPHA
#define CONF_SPI_1_NCPHA 0x1
#endif

// <o> Delay Before SPCK (ns) <0-255000>
// <i> This field defines the delay from NPCS falling edge (activation) to the first valid SPCK transition (in ns).
// <id> spi_master_dlybs
#ifndef CONF_SPI_1_DLY_SPCK
#define CONF_SPI_1_DLY_SPCK 1000
#endif

// <o> Delay Between Consecutive Transfers (ns) <0-8160000>
// <i> This field defines the delay between two consecutive transfers with the same peripheral without removing the chip select (in ns).
// <id> spi_master_dlybct
#ifndef CONF_SPI_1_DLY_BCT
#define CONF_SPI_1_DLY_BCT 1000
#endif

// </e>

/* Calculate baud register value from requested baudrate value */
#ifndef CONF_SPI_1_BAUD_RATE
#define CONF_SPI_1_BAUD_RATE (CONF_SPI1_FREQUENCY / CONF_SPI_1_BAUD)
#endif

/* Calculates the value of the CSR DLYBS field given the desired delay (in ns) */
#ifndef CONF_SPI_1_DLYBS
#define CONF_SPI_1_DLYBS (((CONF_SPI1_FREQUENCY / 1000000) * CONF_SPI_1_DLY_SPCK) / 1000)
#endif

/* Calculates the value of the CSR DLYBCT field given the desired delay (in ns) */
#ifndef CONF_SPI_1_DLYBCT
#define CONF_SPI_1_DLYBCT (((CONF_SPI1_FREQUENCY / 1000000) * CONF_SPI_1_DLY_BCT) / 32000)
#endif
